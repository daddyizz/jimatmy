  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Halaman tidak dijumpai</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Halaman yang dicari tidak wujud atau telah dipindahkan.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Sesuatu telah berlaku. Cuba muatkan semula atau kembali ke halaman utama.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "JimatMY" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: site.locale },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#f7f9f6" },
    ],
    links: [
